...
URL = {
    "train": "https://raw.githubusercontent.com/MattRStoffel/StockBot/main/Stocks%20and%20News/Combined_News_DJIA.csv",
...
def StocksNews(root: str, split: Union[Tuple[str], str]):
